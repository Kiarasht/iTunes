...
public class DateUtils {
     ...
     *
     * @param dateTime A string representing the date of an album release date from the API.
    ...
    private static String getStringDateDifference(long difference) {
        ...
        if (difference_minutes < 1) {
            ...
            return String.valueOf(difference_minutes) + " minute" + isPlural(difference_minutes) + " ago";
        } else if (difference_hours < 24) {
            return String.valueOf(difference_hours) + " hour" + isPlural(difference_hours) + " ago";
        } else if (difference_days < 30) {
            return String.valueOf(difference_days) + " day" + isPlural(difference_days) + " ago";
        } else if (difference_months < 12) {
            return String.valueOf(difference_months) + " month" + isPlural(difference_months) + " ago";
        } else {
            return String.valueOf(difference_years) + " year" + isPlural(difference_years) + " ago";
        }
    }
